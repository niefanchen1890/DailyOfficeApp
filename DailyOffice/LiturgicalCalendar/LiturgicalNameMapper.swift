...
struct LiturgicalNameMapper {
    ...
    private let map: [String: String] = [
        ...
        "聖西面與聖亞拿": "sts_simeon_anna",
        "聖母玫瑰":                   "our_lady_rosary",
        "阿維拉的聖德蘭": "st_teresa_avila",
        ...
        "聖厄休拉及其同伴":         "sts_ursula_and_companions",
        "聖希拉里昂院長":             "st_hilarion",
        ...
        "聖博托爾夫院長":             "st_botolph",
        "聖以法蓮會吏":               "st_ephraem",
        "敬遷聖王愛德華之聖髑": "translation_st_edward_confessor",
