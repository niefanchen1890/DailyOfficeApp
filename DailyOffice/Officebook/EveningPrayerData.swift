...
struct EveningPrayerData {
    ...
    ¶ 主禮需要唸以下一段或數段聖經選句開始晚禱，或者從早禱中選擇；或主禮可於聖經選句後直接唸主禱文。注意，若省略認罪文與赦罪文，主禮人可從聖經選句後，直接唸：「求主幫助我們開口」；省略了的主禱文，需要在「願主與你們同在」等啟應之後，而在其他啟應之前誦讀。
    """
    ...
    static let absolution = AbsolutionBlock(
        ...
        clergyParagraphs: [
            "無所不能的上帝，我主耶穌基督的父，不願罪人死，但願他離開罪惡，可以生活。又把權柄賜與所設立的聖品人，並且吩咐他們曉諭主的百姓，如果悔罪改過，必蒙寬恕赦免。上帝必寬恕赦免一切真心悔罪，誠心信服聖福音的人。",
            "所以，我們須求上帝，賜真實悔改的心，又賜聖靈，叫我們現在所做的，都合主的聖意，又叫我們終身清潔聖善，到了臨終的時候，就可以享永遠的安樂。這都是靠著我主耶穌基督。阿們。"
        ],
        clergyAltRubric: "¶ 會長若不唸上文，唸下文亦可。",
        clergyAltParagraphs: [
            "願全能仁慈的主寬恕、赦免、除去我們所有的罪，並賜予我們真正悔改的時間，生活的改善，及聖靈的恩惠與安慰。阿們。"
        ],
        laypersonRubric: "¶ 注意，若主禮人並非會長，應唸三一主日後第二十四主日之祝文來代替赦罪文：",
        laypersonParagraphs: [
    ...
    // MARK: 恩光頌 (Phos Hilaron) - 晚禱專有
    static let phosHilaron = PrayerSection(
        title: "恩光頌",
        rubric: "¶ 苦難期外，可唸以下聖詩。主禮亦可省略聖詩，直接唸詩篇。",
        paragraphs: [
            "恩慈的真光啊，\n純潔而輝煌，從天上永生聖父而出，\n耶穌基督啊，聖潔而多福！\n現在夕陽西沉，\n我們眼見暮色蒼茫，\n我們歌唱讚美上帝：聖父、聖子和聖靈。\n無論何時，你都配受歡聲讚揚，\n上帝的聖子，賜生命的主啊，\n萬古千秋，永被尊崇。"
        ],
        responses: []
    ...
    static let collects: [PrayerSection] = [
        PrayerSection(
            title: "本日祝文",
            rubric: "¶ 此後，誦唸本日祝文，然後接著誦唸合時的紀念祝文；然後以下面兩篇祝文作為結束。",
        ...
        PrayerSection(
            ...
            rubric: nil,
            paragraphs: [
                "上帝啊，一切潔淨的心願，正直的意念，公義的行為，都是從主那裡出來。求主將世上不能給的平安，賜與我們，叫我們專心順從主的命令，並且倚靠主，不懼怕仇敵，可以平安度日。這都是靠著我主耶穌基督。阿們。"
            ],
            responses: []
        ),
        PrayerSection(
    ...
    static let generalPrayers: [PrayerSection] = [
        PrayerSection(
            ...
            rubric:  nil,
            paragraphs: [
                "無所不能的上帝，主的國度是永遠的，主的權柄是無限的；求主眷顧這個國家，拿正直的標準栽在人民心中，使他們依靠主的律法進行。更求主引導感化我們的國家和一切執政掌權的人員、使他們存大公無私的精神、一心專謀全國的幸福、使全國得享太平。以致真理、公義、虔敬、善行，可以遍行於國中、從現在直到永遠。這都是靠著我主耶穌基督，聖子和聖父、聖靈，一同永生，一同掌權，惟一上帝，永無窮盡。阿們。"
            ],
            responses: []
        ),
        PrayerSection(
    ...
    static let gloriaInExcelsis = GloriaBlock(
        rubric: "¶ 全組詩篇唸完之後，可唸，或唱「榮歸主頌」。",
        bcp1932: [
            "惟願在天上榮耀歸與上帝，在地上人都享平安，受恩惠。我們讚美主，稱頌主，敬拜主，歸榮耀與主，為主的大榮耀，感謝主上帝，天上至大的王，全能的上帝聖父。",
            "主獨生聖子耶穌基督，主上帝，上帝的羔羊，聖父的聖子。除掉世上罪的，憐憫我們。除掉世上罪的，應允我們的禱告。坐在聖父右邊的，憐憫我們。",
            "因為只有基督是聖，只有基督是主，只有基督和聖靈，在聖父榮耀裡同為至上。阿們。"
        ],
        newTranslation: [
