    ...
    struct PentecostOctaveAppendix {
        static var collect: DailyOfficeFile.OfficePeriod.CollectJSON {
            ...
            return DailyOfficeFile.OfficePeriod.CollectJSON(
                ...
                text: isTrad ? "全能最慈悲的上帝，我們懇求主，使我們靠著住在我們裡面的聖靈，得蒙啓發，加增力量服事主。這都是靠著我主耶穌基督。主和聖父、聖靈，惟一上帝，一同永生，一同掌權，世世無盡。阿們。" : "全能最慈悲的上帝，我们恳求主，使我们靠着住在我们里面的圣灵，得蒙启发，加增力量服事主。这都是靠着我主耶稣基督。主和圣父、圣灵，唯一上帝，一同永生，一同掌权，世世无尽。阿们。"
            )
        }
